...
func (this *CodecClientJoinGame) Decode(reader io.Reader) (decode packet.Packet, err error) {
	...
	if deathLocationPresent {
		...
		packetClientJoinGame.DeathLocation = &minecraft.Location{
...
func (this *CodecClientJoinGame) Encode(writer io.Writer, encode packet.Packet) (err error) {
	...
	if packetClientJoinGame.DeathLocation == nil {
		...
		err = packet.WriteString(writer, packetClientJoinGame.DeathLocation.Dimension)
		if err != nil {
			return
		}
		err = packet.WriteInt64(writer, packetClientJoinGame.DeathLocation.Position)
	}
	return
}
