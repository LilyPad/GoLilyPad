...
const (
	...
	PACKET_SERVER_CRAFTING_BOOK_DATA            = 0x1E
	PACKET_SERVER_NAME_ITEM                     = 0x1F
	PACKET_SERVER_RESOURCE_PACK_STATUS          = 0x20
	PACKET_SERVER_ADVANCEMENT_TAB               = 0x21
	PACKET_SERVER_SELECT_TRADE                  = 0x22
	PACKET_SERVER_SET_BEACON_EFFECT             = 0x23
	PACKET_SERVER_HELD_ITEM_CHANGE              = 0x24
	PACKET_SERVER_UPDATE_COMMAND_BLOCK          = 0x25
	PACKET_SERVER_UPDATE_COMMAND_BLOCK_MINECART = 0x26
	PACKET_SERVER_CREATIVE_INVENTORY_ACTION     = 0x27
	PACKET_SERVER_UPDATE_JIGSAW_BLOCK           = 0x28
	PACKET_SERVER_UPDATE_STRUCTURE_BLOCK        = 0x29
	PACKET_SERVER_UPDATE_SIGN                   = 0x2A
	PACKET_SERVER_ANIMATION                     = 0x2B
	PACKET_SERVER_SPECTATE                      = 0x2C
	PACKET_SERVER_PLAYER_BLOCK_PLACEMENT        = 0x2D
	PACKET_SERVER_USE_ITEM                      = 0x2E
