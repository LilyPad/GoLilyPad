...
const (
	...
	PACKET_CLIENT_SPAWN_MOB                     = 0x03 // changed
	PACKET_CLIENT_SPAWN_PAINTING                = 0x04
	PACKET_CLIENT_SPAWN_PLAYER                  = 0x05 // changed
	PACKET_CLIENT_ANIMATION                     = 0x06
	PACKET_CLIENT_STATISTICS                    = 0x07
	PACKET_CLIENT_ACKNOWLEDGE_PLAYER_DIGGING    = 0x08 // id 0x5C -> 0x08
	PACKET_CLIENT_BLOCK_BREAK_ANIMATION         = 0x09
	PACKET_CLIENT_UPDATE_BLOCK_ENTITY           = 0x0A // changed
	PACKET_CLIENT_BLOCK_ACTION                  = 0x0B
	PACKET_CLIENT_BLOCK_CHANGE                  = 0x0C
	PACKET_CLIENT_BOSS_BAR                      = 0x0D
	PACKET_CLIENT_DIFFICULTY                    = 0x0E
	PACKET_CLIENT_CHAT                          = 0x0F
	PACKET_CLIENT_MULTI_BLOCK_CHANGE            = 0x10
	PACKET_CLIENT_TAB_COMPLETE                  = 0x11
	PACKET_CLIENT_DECLARE_COMMANDS              = 0x12
	PACKET_CLIENT_CONFIRM_TRANSACTION           = 0x13
	PACKET_CLIENT_CLOSE_WINDOW                  = 0x14
	...
	PACKET_CLIENT_CHUNK_DATA                    = 0x22 // changed
	PACKET_CLIENT_EFFECT                        = 0x23
	PACKET_CLIENT_PARTICLE                      = 0x24 // changed
	PACKET_CLIENT_UPDATE_LIGHT                  = 0x25
	PACKET_CLIENT_JOIN_GAME                     = 0x26 // changed
	PACKET_CLIENT_MAPS                          = 0x27
	PACKET_CLIENT_TRADE_LIST                    = 0x28
	PACKET_CLIENT_ENTITY_RELATIVE_MOVE          = 0x29
	PACKET_CLIENT_ENTITY_LOOK_AND_RELATIVE_MOVE = 0x2A
	PACKET_CLIENT_ENTITY_LOOK                   = 0x2B
	PACKET_CLIENT_ENTITY                        = 0x2C
	PACKET_CLIENT_VEHICLE_MOVE                  = 0x2D
	PACKET_CLIENT_OPEN_BOOK                     = 0x2E
	PACKET_CLIENT_OPEN_WINDOW                   = 0x2F
	PACKET_CLIENT_SIGN_EDITOR_OPEN              = 0x30
	PACKET_CLIENT_CRAFT_RECIPE_RESPONSE         = 0x31
	PACKET_CLIENT_PLAYER_ABILITIES              = 0x32
	PACKET_CLIENT_COMBAT_EVENT                  = 0x33
	...
	PACKET_CLIENT_RESPAWN                       = 0x3B // changed
	PACKET_CLIENT_ENTITY_HEAD_LOOK              = 0x3C
	PACKET_CLIENT_ADVANCEMENT_PROGRESS          = 0x3D
	PACKET_CLIENT_WORLD_BORDER                  = 0x3E
	PACKET_CLIENT_CAMERA                        = 0x3F
	PACKET_CLIENT_HELD_ITEM_CHANGE              = 0x40
	PACKET_CLIENT_UPDATE_VIEW_POSITION          = 0x41
	PACKET_CLIENT_UPDATE_VIEW_DISTANCE          = 0x42
	...
	PACKET_CLIENT_SPAWN_POSITION                = 0x4E
	PACKET_CLIENT_TIME_UPDATE                   = 0x4F
	PACKET_CLIENT_TITLE                         = 0x50
	PACKET_CLIENT_ENTITY_SOUND_EFFECT           = 0x51
	PACKET_CLIENT_SOUND_EFFECT                  = 0x52
	PACKET_CLIENT_STOP_SOUND                    = 0x53
	PACKET_CLIENT_PLAYER_LIST_HEAD_FOOT         = 0x54
	PACKET_CLIENT_NBT_QUERY_RESPONSE            = 0x55
	PACKET_CLIENT_COLLECT_ITEM                  = 0x56
	PACKET_CLIENT_ENTITY_TELEPORT               = 0x57
	PACKET_CLIENT_ADVANCEMENTS                  = 0x58
	PACKET_CLIENT_ENTITY_PROPERTIES             = 0x59
	PACKET_CLIENT_ENTITY_EFFECT                 = 0x5A
	PACKET_CLIENT_DECLARE_RECIPES               = 0x5B
	PACKET_CLIENT_TAGS                          = 0x5C
	...
	PACKET_SERVER_LOCK_DIFFICULTY               = 0x10
	PACKET_SERVER_PLAYER_POSITION               = 0x11
	PACKET_SERVER_PLAYER_LOOK_AND_POSITION      = 0x12
	PACKET_SERVER_PLAYER_LOOK                   = 0x13
	PACKET_SERVER_PLAYER                        = 0x14
	PACKET_SERVER_VEHICLE_MOVE                  = 0x15
	PACKET_SERVER_STEER_BOAT                    = 0x16
	PACKET_SERVER_PICK_ITEM                     = 0x17
	PACKET_SERVER_CRAFT_RECIPE_REQUEST          = 0x18
	PACKET_SERVER_PLAYER_ABILITIES              = 0x19
	PACKET_SERVER_PLAYER_DIGGING                = 0x1A
	PACKET_SERVER_ENTITY_ACTION                 = 0x1B
	PACKET_SERVER_STEER_VEHICLE                 = 0x1C
	PACKET_SERVER_CRAFTING_BOOK_DATA            = 0x1D
	PACKET_SERVER_NAME_ITEM                     = 0x1E
	PACKET_SERVER_RESOURCE_PACK_STATUS          = 0x1F
	PACKET_SERVER_ADVANCEMENT_TAB               = 0x20
	PACKET_SERVER_SELECT_TRADE                  = 0x21
	PACKET_SERVER_SET_BEACON_EFFECT             = 0x22
	PACKET_SERVER_HELD_ITEM_CHANGE              = 0x23
	...
	PACKET_SERVER_UPDATE_JIGSAW_BLOCK           = 0x27
	PACKET_SERVER_UPDATE_STRUCTURE_BLOCK        = 0x28
	PACKET_SERVER_UPDATE_SIGN                   = 0x29
	PACKET_SERVER_ANIMATION                     = 0x2A
	PACKET_SERVER_SPECTATE                      = 0x2B
	PACKET_SERVER_PLAYER_BLOCK_PLACEMENT        = 0x2C
