...
const (
	...
	PACKET_CLIENT_DECLARE_COMMANDS              = 0x11
	...
	PACKET_CLIENT_OPEN_HORSE_WINDOW             = 0x1F // new
	...
	PACKET_CLIENT_COMBAT_EVENT                  = 0x32
	PACKET_CLIENT_PLAYER_LIST                   = 0x33
	PACKET_CLIENT_FACE_PLAYER                   = 0x34
	PACKET_CLIENT_PLAYER_POSITION_AND_LOOK      = 0x35
	PACKET_CLIENT_UNLOCK_RECIPES                = 0x36
	PACKET_CLIENT_DESTROY_ENTITIES              = 0x37
	PACKET_CLIENT_REMOVE_ENTITY_EFFECT          = 0x38
	PACKET_CLIENT_RESOURCE_PACK                 = 0x39
	PACKET_CLIENT_RESPAWN                       = 0x3A
	PACKET_CLIENT_ENTITY_HEAD_LOOK              = 0x3B
	...
	PACKET_CLIENT_ENTITY_VELOCITY               = 0x45
	PACKET_CLIENT_ENTITY_EQUIPMENT              = 0x46
	PACKET_CLIENT_SET_EXPERIENCE                = 0x47
	PACKET_CLIENT_UPDATE_HEALTH                 = 0x48
	PACKET_CLIENT_SCOREBOARD_OBJECTIVE          = 0x49
	PACKET_CLIENT_SET_PASSENGERS                = 0x4A
	PACKET_CLIENT_TEAMS                         = 0x4B
	PACKET_CLIENT_UPDATE_SCORE                  = 0x4C
	...
	PACKET_CLIENT_USE_BED                       = -1 // removed
...
var Version03 = &minecraft.Version{
	Name:             "1.14.3",
	LoginClientCodec: mc18.LoginPacketClientCodec,
	LoginServerCodec: mc18.LoginPacketServerCodec,
	PlayClientCodec:  PlayPacketClientCodec,
...
var Version04 = &minecraft.Version{
	Name:             "1.14.4",
	LoginClientCodec: mc18.LoginPacketClientCodec,
	LoginServerCodec: mc18.LoginPacketServerCodec,
	PlayClientCodec:  PlayPacketClientCodec,
...
var VersionNum03 = 490
var VersionNum04 = 498
